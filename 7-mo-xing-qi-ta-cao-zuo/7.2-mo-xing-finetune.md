...
> 本章代码：[https://github.com/zhangxiann/PyTorch\_Practice/blob/master/lesson7/finetune\_resnet18.py](https://github.com/zhangxiann/PyTorch_Practice/blob/master/lesson7/finetune_resnet18.py)
...
数据下载地址：[http://download.pytorch.org/tutorial/hymenoptera\_data.zip](http://download.pytorch.org/tutorial/hymenoptera_data.zip)

预训练好的模型参数下载地址：[http://download.pytorch.org/models/resnet18-5c106cde.pth](http://download.pytorch.org/models/resnet18-5c106cde.pth)
...
![](https://image.zhangxiann.com/20200707194544.png)
...
![](https://image.zhangxiann.com/20200707210357.png)
...
3. 在 data\_loader 取数据的循环中，把每个 mini-batch 的数据和 label 加载到 device：`inputs, labels = inputs.to(device), labels.to(device)`
